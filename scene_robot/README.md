...
- `src/grasp_annotator`: multiview GLB grasp proposal pipeline exporting `point_grasp`, `axis_band`, and `pose_set` primitives.
...
python scene_robot/scripts/grasp_annotate.py annotate-one --file ./object.glb --output-dir ./runs
