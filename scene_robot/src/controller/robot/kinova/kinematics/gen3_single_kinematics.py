...
class Gen3SingleKinematics(RobotKinematics):
    ...
    def _init_fixed_base_kinematics(self):
        ...
        self.opti.minimize(10 * self.translational_cost + 1*self.rotation_cost + 0.01 * self.regularization_cost + 0.01 * self.smooth_cost)
    ...
    def inverse_kinematics(self, T , current_lr_arm_motor_q = None, current_lr_arm_motor_dq = None):
        ...
        self.opti.set_value(self.param_tf_r, ee_target)
