...
CONTROLLER_RESOURCE_DIR = os.path.join(
...
class RobotKinematics(ABC):
    ...
    def load_collision_spheres(self):
        ...
        """
        if self.robot_cfg.collision_spheres_json_path is None:
            return {}
        path = os.path.join(CONTROLLER_RESOURCE_DIR, self.robot_cfg.collision_spheres_json_path)
