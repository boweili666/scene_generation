...
DEFAULT_IMAGE_PATH = Path("/home/lbw/3dgen-project/sam3/scene_60.jpeg")
DEFAULT_SCENE_GRAPH = Path(
    "/home/lbw/Downloads/isaac-sim-standalone-5.0.0-linux-x86_64/bowei/my_viewer/full_scene_graph.json"
)
DEFAULT_OUTPUT_ROOT = Path("/home/lbw/3dgen-project/scene_graph_ui_test/option2_pipeline/runtime/masks")
DEFAULT_MESH_OUTPUT = Path("/home/lbw/3dgen-project/scene60_mesh_rts")
DEFAULT_REUSE_MESH_DIR = Path("/home/lbw/3dgen-project/scene60_mesh_rts")
...
def main() -> None:
    ...
    for prompt in prompts:
        ...
        for idx, mask in enumerate(masks):
            ...
            mask_path = class_dir / f"{prompt_key}_{idx}.png"
            rgba_full_path = class_dir / f"{prompt_key}_{idx}_rgba_fullsize.png"
            rgba_crop_path = class_dir / f"{prompt_key}_{idx}_rgba_crop.png"
