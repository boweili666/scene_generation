...
ISAAC_SCRIPT = str(PROJECT_ROOT / "pipelines" / "isaac" / "save_figure.py")
ASSET_CONVERTER_SCRIPT = str(PROJECT_ROOT / "pipelines" / "isaac" / "asset_convert.py")
...
REAL2SIM_SEGMENT_SCRIPT = os.path.join("pipelines", "real2sim", "segment_objects.py")
REAL2SIM_PREDICT_STREAM_CLIENT = os.path.join("pipelines", "real2sim", "predict_stream_client.py")
